#!/usr/bin/env python3
"""
Integration tests for Snowflake MCP Server container
"""
...
class TestSnowflakeIntegration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.container_name = "snowflake-mcp-test"
        cls.image_name = "snowflake-mcp:test"
        cls.container = None
    ...
    def test_environment_variable_validation(self):
        ...
        # Test with invalid account (empty)
        invalid_env = self.test_env.copy()
        invalid_env['SNOWFLAKE_ACCOUNT'] = ''
        ...
        try:
            ...
            logs = container.logs().decode('utf-8')
            self.assertIn('Missing required Snowflake configuration', logs)
    ...
    def test_container_logs_structure(self):
        ...
        self.assertIn('Starting Snowflake MCP Server', logs)
...
class TestSnowflakeMockIntegration(unittest.TestCase):
    """Integration tests with mock database connections"""
    
    def setUp(self):
        """Set up mock test environment"""
        self.docker_client = docker.from_env()
        self.image_name = "snowflake-mcp:test"
        
        # Mock environment that won't actually connect to Snowflake
        self.mock_env = {
